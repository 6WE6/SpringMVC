package com.zzuli.web.annotion;
...
import com.zzuli.web.bean.User;
...
/*	@RequestMapping("/param9")
	...
	public String paramTest16(@RequestParam(value="name",defaultValue="#{T(com.zzuli.web.bean.User).sayYou()}") String name){
		System.out.println(name+"=====");
		return "hello";
	}
	/**
